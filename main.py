...
while True:
    ...
    if op != '1' and op != '2' and op != '0':
        ...
        while True:
            ...
            if op2 != '1' and op2 != '2' and op2 != '0':
                print('Erro. Tente novamente')

            elif op2 == "1":
                print()
                print('=' * 10, 'Cadastro de Usuário', '=' * 10)
                usuario = input('Digite o nome de usuário ou 0-Sair: ')
                if usuario == '0':
                    break
                ...
                usuarios.append([usuario, senha, 'ADM'])

                print(usuarios)

            elif op2 == "2":
                print()
                print('=' * 10, 'Cadastros de Usuário', '=' * 10)
                usuario = input('Digite o nome de usuário ou 0-Sair: ')
                if usuario == '0':
                    break
                ...
                if senha != confirm:
                    print('Senha inválida. Tente novamente.')
                usuarios.append([usuario, senha, 'CLI'])
                    ...
                    while True:
                        ...
                        if escolha == '1':
                            while True:
                                ...
                                op3 = input('Digite sua opção: ')

                                if op3 == '1':
                                    print()
                                    print('=' * 10, 'Cadastrar animal', '=' * 10)

                                    tipo = input('Informe o tipo (Bovino de leite, Caprino, Ovino, Suíno/Leitão): ').strip().lower()
                                    ident = input('Brinco/Número: ')

                                    encontrei = False

                                    for brinco in animais:
                                        if brinco[1] == ident:
                                            encontrei = True
                                            print("Brinco ja existe!")
                                            break
                                    if not encontrei:
                                        status = input(
                                            'Status do animal (Em Lactação, Engorda, Disponível para venda: ').strip().lower()
                                        animal = [tipo, ident, status]
